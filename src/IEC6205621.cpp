...
IEC6205621::IEC6205621(const char* p, Timezone* tz) {
	...
	if(val > 0) meterCounter_total.activeImportCounter = val / 1000; //DGF changed to total
	...
	if(val > 0) meterCounter_total.activeExportCounter = val / 1000; //DGF changed to total
	...
	if(val > 0) meterCounter_total.reactiveImportCounter = val / 1000; //DGF changed to total
	...
	if(val > 0) meterCounter_total.reactiveExportCounter = val / 1000; //DGF changed to total

	if(meterCounter_total.activeImportCounter > 0 || meterCounter_total.activeExportCounter > 0 || meterCounter_total.reactiveImportCounter > 0 || meterCounter_total.reactiveExportCounter > 0) //DGF changed to total
		listType = 3;
