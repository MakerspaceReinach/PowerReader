...
bool HomeAssistantMqttHandler::publishList3(AmsData* data, EnergyAccounting* ea) {
    publishList3Sensors();
    if(data->getActiveExportCounterTotal() > 0.0) publishList3ExportSensors();  //DGF changed to 'total'
    snprintf_P(json, BufferSize, HA2_JSON,
        data->getActiveImportCounterTotal(),  //DGF changed to 'total'
        data->getActiveExportCounterTotal(),  //DGF changed to 'total'
        data->getReactiveImportCounterTotal(),  //DGF changed to 'total'
        data->getReactiveExportCounterTotal(),  //DGF changed to 'total'
