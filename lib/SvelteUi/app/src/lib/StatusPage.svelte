...
<div class="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2">
    ...
    <div class="cnt">
        ...
        <div class="my-2"><!-- EHorvat next line was :   Installed version: {sysinfo.version} -->
            Installierte Version: pre2.7-dgf
        </div>        
    ...
    <div class="cnt">
        ...
        <form method="get" action="/configfile.cfg" autocomplete="off">
            <div class="grid grid-cols-2">
                ...
                {/each}
                <label class="my-1 mx-3 col-span-2"><input type="checkbox" class="rounded" name="ic" value="true"/> Mit Passw&ouml;rtern<br/><small>(SSID, PSK, Passwörter und Token)</small></label>
            </div>
