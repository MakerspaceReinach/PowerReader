...
<nav class="bg-violet-600 p-1 rounded-md mx-2">
      ...
      <div class="flex-auto p-2 flex flex-row-reverse flex-wrap">
          <div class="flex-none">
            <!--<a class="float-right" href='https://github.com/ehorvat1/NES-MEP-Reader' target='_blank' rel="noreferrer" aria-label="GitHub"><img class="gh-logo" src={GitHubLogo} alt="GitHub repo"/></a>--><!--DGF Github icon removed (no automatic firmware updates)-->
          </div>
