...
//DGF structore of meter counter values (introduced for tariffs)
typedef struct
  {
      double activeImportCounter = 0;
      double activeExportCounter = 0;
      double reactiveImportCounter = 0;
      double reactiveExportCounter = 0;
  } MeterCounter;
//DGF
//DGF 14-DEC-2023 tariffs added
class AmsData {
public:
    AmsData();
    ...
    uint8_t setfromNESMEP_1(long ActiveImportPower,
                            ...
                            float L1Current,
                            float L2Current,
                            float L3Current, // Ehotvat
                            byte CurrentTierId);  // DGF 04-DEC-2023 Tariff id added
    ...
    double getActiveImportCounterTotal(); //DGF
    double getReactiveImportCounterTotal(); //DGF
    double getActiveExportCounterTotal(); //DGF
    double getReactiveExportCounterTotal(); //DGF
    //DGF
    double getActiveImportCounterTier(byte); 
    double getReactiveImportCounterTier(byte); 
    double getActiveExportCounterTier(byte); 
    double getReactiveExportCounterTier(byte); 
    //DGF
    byte getCurrentTierId();         // DGF 04-DEC-2023
...
protected:
    ...
    MeterCounter meterCounter_total;
    MeterCounter meterCounter_tiers[8];
